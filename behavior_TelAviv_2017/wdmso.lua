...
local beta_tt_bus_mrt = -2.78 / 60
local beta_tt_private_bus = 0  / 60
local beta_tt_drive1 = -4.65 / 60
local beta_tt_share2= -3.59 / 60
local beta_tt_share3= -2.14 / 60
local beta_tt_motor = 0 / 60
local beta_tt_walk = -5.05 / 60
local beta_tt_taxi = -3.33 / 60
