...
local beta_arr_1_cos2pi = -1.04  -0.4-0.1-0.1
local beta_arr_1_cos4pi = -0.232   -0.1-0.08-0.4
local beta_arr_1_cos6pi = 1.056 -0.1  -0.3 -0.3 +1-0.5-0.8 +0.7
local beta_arr_1_sin2pi = 1.72        -0.3 -0.2-0.08-0.3+0.2
local beta_arr_1_sin4pi = -0.25  -0.3-0.1-0.1-1+0.5
local beta_arr_1_sin6pi = -0.212  +0.1+0.2-0.08-0.3-0.3-0.1

local beta_dep_1_cos2pi = -0.5   -0.8 +0.8 -0.5 -0.3 - 0.3 -0.25
local beta_dep_1_cos4pi = 0.46  - 0.6-0.3+0.9 -0.7 - 0.6+0.15 +0.15+0.25-0.3
local beta_dep_1_cos6pi = -0.082  -0.4  +0.4 -0.2 -0.17
local beta_dep_1_sin2pi = -0.88 +0.6 -0.3 +0.3
local beta_dep_1_sin4pi = 0.566 -0.4 +0.4 
local beta_dep_1_sin6pi = 0.75 +0.1  -0.2-0.2 -0.2 -0.3
