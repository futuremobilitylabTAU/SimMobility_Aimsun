...
local beta_DUR_1 = -1.98 -- -1.98
local beta_DUR_2 = 0.0282
local beta_DUR_3 = 0

--local beta_arr_1_cos2pi = -0.86-- - 3.0 -- 6.0
--local beta_arr_1_cos4pi = 0 -- - 2.0
--local beta_arr_1_cos6pi = -0.515 -- + 1.0
--local beta_arr_1_sin2pi = 1 -- + 1.5 -- 2.5 Step 2
--local beta_arr_1_sin4pi = -0.287 -0.2
--local beta_arr_1_sin6pi = -0.271

--local beta_dep_1_cos2pi = 3.81 - 1.0 -- 2.0
--local beta_dep_1_cos4pi = 3.02 - 1.0
--local beta_dep_1_cos6pi = 0.937 --- 0.5 
--local beta_dep_1_sin2pi = -7.39
--local beta_dep_1_sin4pi = -1.11
--local beta_dep_1_sin6pi = 0.179

--local beta_arr_tt = 0 + 0.002
--local beta_dep_tt = 0.00857 - 0.003 -- step 1

local beta_arr_1_cos2pi = -6.86 +0.4 +0.1
local beta_arr_1_cos4pi = -3.01 
local beta_arr_1_cos6pi = -0.515 -0.3 +0.2
local beta_arr_1_sin2pi = 5.33 -0.2 
