...
local beta1_1_tt = -0.687 / 60
local beta1_2_tt = -0.690 / 60
local beta1_3_tt = -1.06 / 60

local beta_private_1_tt= -0.659 / 60

local beta2_tt_drive1 = -0.736 / 60
local beta2_tt_share2 = -1.42 / 60
local beta2_tt_share3 = -1.18 / 60
local beta2_tt_motor = 0 / 60

local beta_tt_walk = -3.72 / 60
local beta_tt_taxi = -2.84 / 60
