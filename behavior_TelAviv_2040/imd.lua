...
local function computeUtilities(params,dbparams)
	...
	for i =1,num_zone do
		...
		cost_bus_first[i]=dbparams:cost_public_first(i)
        	--cost_bus_car_first[i]=dbparams:cost_public_first(i) -- dbparams:cost_pub_car_first(i) --removed on 16/04/2023
      	--cost_bus_mod_first[i]=dbparams:cost_public_first(i) -- dbparams:cost_pub_mod_first(i) --removed on 16/04/2023
		tt_bus_walk_first[i] = dbparams:tt_pub_first(i)
		-- tt_bus_car_first[i] = dbparams:tt_pub_first(i) -- dbparams:tt_pub_car_first(i) --removed on 16/04/2023
		-- tt_bus_mod_first[i] = dbparams:tt_pub_first(i) -- dbparams:tt_pub_mod_first(i) --removed on 16/04/2023
		...
		--MRT
	      ...
	      --tt_MRT_first[i] = dbparams:tt_mrt_first(i) --removed on 16/04/2023
	...
	for i =1,num_zone do
		...
		cost_bus_second[i]=dbparams:cost_public_second(i)
        	--cost_bus_car_second[i]=dbparams:cost_public_second(i) -- dbparams:cost_pub_car_second(i) --removed on 16/04/2023
        	--cost_bus_mod_second[i]=dbparams:cost_public_second(i) -- dbparams:cost_pub_mod_second(i) --removed on 16/04/2023
		tt_bus_walk_second[i] = dbparams:tt_pub_second(i)
		--tt_bus_car_second[i] = dbparams:tt_pub_second(i) -- dbparams:tt_pub_car_second(i) --removed on 16/04/2023
		--tt_bus_mod_second[i] = dbparams:tt_pub_second(i) -- dbparams:tt_pub_mod_second(i) --removed on 16/04/2023		
		...
		--MRT
           ...
           --tt_MRT_second[i] =dbparams:tt_mrt_second(i)	--removed on 16/04/2023
...
--    Alternatives where second trip is fixed to tour mode (1, N_zones*Nmodes)
	...
	for i =1,num_zone do
		...
		--beta_tt_MRT * tt_MRT_first[i] +  --removed on 16/04/2023 from mrt utility
	...
	-- on 16/04/2023 all the utility function where fixed to use the second cost an time
	...
	--beta_tt_MRT * tt_MRT_second[i] +  --removed on 16/04/2023 from mrt utility
