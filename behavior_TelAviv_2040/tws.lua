...
local beta_cons_NQ = -2.66+10+10    -20
...
local function computeUtilities(params,dbparams)
	...
	--local income_mid =  {3.40,3.85,4.38,4.93,5.46,6.09,6.67,7.16,8.16,9.60} -- 10K Dollar hearly
	--local income_mid = {500,1250,1750,2250,2750,3500,4500,5500,6500,7500,8500,0,99999,99999} --dollar monthly 
