...
local beta_private_1_tt = -0.466 / 60

local beta2_tt_drive1 = -0.980 / 60
local beta2_tt_share2 = -1.46 / 60
local beta2_tt_share3 = -1.47 / 60
local beta2_tt_motor = -0.897 / 60

local beta_tt_walk = -2.21 / 60
local beta_tt_taxi = -1.17 / 60
