...
local beta_C = -0.0933 
local beta_DUR_1 = -0.770 -0.2 
local beta_DUR_3 = 0.00223  -0.2 -0.4 
local beta_DUR_2 = -0.115 -0.2 -0.2  +7 -0.5
 
local beta_ARR_1_1 = 7.79   -5 +3  +5.5
local beta_ARR_1_2 = -3.94+7
local beta_ARR_1_3 = -3.25 
local beta_ARR_1_4 = -27.6  +8 
local beta_ARR_1_5 = -16.1 
local beta_ARR_1_6 = 5.43   -2
 
local beta_TT1 = 0.0 



local beta_DEP_1_1 = -9.33 +6 
local beta_DEP_1_2 = 2  -1  -0.04  +0.1 +0.1 -7
local beta_DEP_1_3 = 0 +4 -1 -0.1 +0.2 
local beta_DEP_1_4 = 0 - 2 +1 -0.1
local beta_DEP_1_5 = -2 +0.2 +0.15
local beta_DEP_1_6 = -1.64  +0.5 -1+0.5 
local beta_TT2 = 0.0  
...
local function computeUtilities(params,dbparams) 
	...
	for i =1,1176 do
		...
		utility[i] = sarr_1(arr)/1.75 + sdep_1(dep) + beta_DUR_1 * dur + beta_DUR_2 * pow(dur,2) + beta_DUR_3 * pow(dur,3) + beta_TT1 * dbparams:TT_HT1(arrid) + beta_TT2 * dbparams:TT_HT2(depid) + beta_C * (cost_HT1_am * arr_am + cost_HT1_pm * arr_pm + cost_HT1_op * arr_op + cost_HT2_am * dep_am + cost_HT2_pm * dep_pm + cost_HT2_op * dep_op)
	end
end
--availability
