...
-- CONSTANS
local beta_cons_usual = 5.92 + 10 + 10 -15 +5 -10 -2 +1 +0.5 +0.5 +0.5
...
local function computeUtilities(params,dbparams)
	...
	utility[2] = beta_cons_unusual + beta_INCOME_unusual * INCOME + beta_age20_unusual * age20 + beta_age2025_unusual * age2025 + beta_age2635_unusual * age2635 + beta_age5165_unusual * age5165 + beta_age65_unusual * age65 + beta_parttime_unusual * parttime + beta_female_unusual * female + beta_LIC_unusual * LIC + beta_TRANS_unusual * TRANS + beta_distance_log_unusual * math.log(WORKDist) + beta_MULTJOBS_unusual * MULTJOBS + beta_FLEXSCHED_unusual * FLEXSCHED
